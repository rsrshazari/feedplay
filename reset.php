...
if(isset($_POST['submit']))
	{
		...
		$apwd=md5($_POST['password']);
			$admres=mysqli_query($con,"select * from `user` where `email_id`='$email' and `password`='$apwd' ");
           ...
           <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ">
             <div class="card card-plain">
               ...
               <div class="card-header pb-0 text-start">
                 ...
                 <p class="mb-0">You will receive an reset link in maximum 60 seconds</p>
               </div>
               <div class="card-body">
...
<?php }?>
                 <form role="form" method="post" >
                   ...
                   <div class="text-center">
                     <button type="submit" name="reset" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Send</button>
                   </div>
                 </form>
               </div>
