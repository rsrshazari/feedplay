...
if (isset($_GET['uid'])&&$_GET['uid']!='') {
  ...
  $audio=getTotalAudio($user['id']);
  $brands=getBrandsByUserId($user['id']);
  $work=getWorkspaceByUserId($user['id']);
  $userType=$user['user_type'];
  $package=getSubscriptionDetailsById($user['package']);
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> &nbsp;   <?=$user['contact_no']?></li>
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Email:</strong> &nbsp;   <?=$user['email_id']?></li>
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Package Type:</strong> &nbsp;  <?php if ($user['package_type']=='1') { echo 'Yearly';}else{ echo 'Monthly' ;} ?></li>
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Packege Amount:</strong> &nbsp;   <?php if ($user['package_type']=='1') { echo $package[8];}else{ echo $package[7] ;} ?></li>
                ...
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Expiry:</strong> &nbsp; <?= date('M d, Y', strtotime($user['expiry'])) ?>   </li>
              </ul>
            </div>
          </div>
        </div>
      <?php }else{ $wspace=getWorkspaceDetailsById($user['wid'])?>
        <div class="col-12 col-xl-4 mt-xl-0 mt-4">
          <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">Worksapce Information</h6>
            </div>
            <div class="card-body p-3">
              <hr class="horizontal gray-light my-4">
              <ul class="list-group">
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Workspace Name:</strong> &nbsp;  <?=$wspace[3]?></li>
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Expiry:</strong> &nbsp; <?= date('M d, Y', strtotime($user['expiry'])) ?>   </li>
              </ul>
            </div>
          </div>
