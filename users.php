              ...
              <div class="d-lg-flex">
                ...
                <div class="ms-auto my-auto mt-lg-0 mt-4">
                  <div class="ms-auto my-auto">
                    <a href="adduser.php"  class="btn bg-gradient-danger btn-sm mb-0" ><i class="fa-solid fa-crown"></i> Create New Package</a>
                </div>
                </div>
              </div>
            </div>
            <div class="card-body px-0 pb-0">
              <div class="table-responsive">
                <table class="table table-flush" id="products-list">
                  ...
                  <tbody>
                    <?php $qry=mysqli_query($con,"select * from user where is_deleted='0'  order by id desc");
                      $sl=0;
                     ...
                     ?>
	                     ...
	                     <td class="text-sm">
	                       <a href="javascript:;" class=" badge badge-sm bg-gradient-success" title="Preview ">
	                         <i class="ni ni-tv-2"></i>
	                       </a>
	                       <a href="javascript:;" class=" badge badge-sm bg-gradient-info" title="Edit User">
	                       ...
	                       <a href="workspace.php?did=<?=base64_encode($user['id'])?>" onClick="return confirm(' Are you sure you want to delete !!')" class="badge badge-sm bg-gradient-danger" title="Delete User">
	                         <i class="ni ni-fat-remove" ></i> Del
	                       </a>
	                     </td>
	                   </tr>
	                 <?php }}else{  ?>
