...
if (isset($_GET['uid'])&&$_GET['uid']!='') {
  ...
  $user=mysqli_fetch_array(mysqli_query($con,"select * from user where id=$uid"));
}
...
<html><head>
  ...
  <title>Feed Play | Workspace Users </title>
              ...
              <div class="col-lg-9 mt-lg-0 mt-4">
                  ...
                  <div class="row justify-content-center align-items-center">
                    <div class="col-sm-auto col-4">
                      <div class="avatar avatar-xl position-relative">
                        <?php if ($user['photo']==''){ ?>
                              <img id="profileImg" src="assets1/img/user/1.png" alt="<?=$user['name']?>" class="w-100 border-radius-lg shadow-sm">
                        <?php }else{ ?>
                      <img id="profileImg" src="assets1/img/user/<?=$user['photo']?>" alt="<?=$user['name']?>" class="w-100 border-radius-lg shadow-sm">
                    <?php } ?>
                    ...
                    <div class="col-sm-auto ms-sm-auto mt-sm-0 mt-3 d-flex">
                        <?php echo getuserStatus($user['is_active']) ?>
                    </div>
                  </div>
                </div>
                <!-- Card Basic Info -->
                <div class="card mt-4" id="basic-info">
                  ...
                  <div class="card-body pt-0">
                    <input type="hidden" name="imgId" value="<?=$user['photo']?>">
                    <input type="hidden" name="hidId" value="<?=$user['id']?>">
                      <div class="row">
                      <div class="col-12">
                        <label class="form-label">Full Name</label>
                        <div class="input-group">
                          <input id="uName" name="uName" class="form-control" value="<?=$user['name']?>" type="text" placeholder="Alec" required="required" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6">
                        ...
                        <div class="input-group">
                          <input id="email" name="email" class="form-control" type="email" value="<?=$user['email_id']?>" placeholder="example@email.com" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                      <div class="col-6">
                    ...
                    <div class="row">
                      <div class="col-6">
                        ...
                        <div class="input-group">
                          <input id="address" name="address" class="form-control" type="text" value="<?=$user['address']?>" placeholder="Sydney, A" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                      <div class="col-6">
                        <label class="form-label mt-4">Phone Number</label>
                        <div class="input-group">
                          <input id="phone" name="phone" class="form-control" type="number" value="<?=$user['contact_no']?>" placeholder="+40 735 631 620" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-12">
                        ...
                        <div class="input-group">
                          <textarea name="bio" id="bio" rows="8" cols="80" class="form-control"><?=$user['bio']?></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-12">
                        ...
                        <div class="input-group">
                          ...
                          <input id="website" name="website" class="form-control" value="<?=$user['website']?>" type="text" placeholder="www.gofeeds.com" required="required" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6">
                        ...
                        <div class="input-group">
                          <input id="twitter" name="twitter" class="form-control" value="<?=$user['twitter']?>" type="text" placeholder="https://twitter.com/home?lang=en" required="required" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                      <div class="col-6">
                        <label class="form-label">Facebook</label>
                        <div class="input-group">
                          <input id="facebook" name="facebook" class="form-control" value="<?=$user['facebook']?>" type="text" placeholder="Thompson" required="required" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-6">
                        ...
                        <div class="input-group">
                          <input id="linkedin" name="linkedin" class="form-control" type="text" value="<?=$user['linkedin']?>" placeholder="example@email.com" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                      <div class="col-6">
                        <label class="form-label mt-4">Instagram</label>
                        <div class="input-group">
                          <input id="instagram" name="instagram" class="form-control" type="text" value="<?=$user['instagram']?>" placeholder="example@email.com" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                ...
                <div class="card mt-4" id="delete">
                  ...
                  <div class="card-body d-sm-flex pt-0" style="justify-content: space-between;">
                    ...
                    <?php if ($user['is_active']=='1'){ ?>
                      <a href='edituser.php?eid=<?php echo  base64_encode($user['id'])?>&act=<?=$user['is_active']?>'><button class="btn btn-outline-secondary mb-0 ms-auto" type="button" name="button">Block User</button></a>
                    <?php }else{ ?>
                    <a href='edituser.php?eid=<?php echo  base64_encode($user['id'])?>&act=<?=$user['is_active']?>'><button class="btn btn-outline-secondary mb-0 ms-auto" type="button" name="button">Activate User</button></a>
                      <?php } ?>
                    <a href='workspace.php?did=<?php echo base64_encode($user['id'])?>'> <button onclick="return confirm('Are you sure want to delete!!')" class="btn bg-gradient-danger mb-0 ms-2" type="button" name="button">Delete Account</button>
                  </div>
                </div>
              </div>
            </div>
