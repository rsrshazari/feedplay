...
$delQry=mysqli_query($con,"update workspace set is_deleted='1' where `id`='$did'");
if($delQry){
...
<html><head>
  ...
  <title>Feed Play | Admin workspace </title>
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header pb-0">
              <div class="d-lg-flex">
                <div>
                  <h5 class="mb-0">All Workspace</h5>
                ...
                <div class="ms-auto my-auto mt-lg-0 mt-4">
                  <div class="ms-auto my-auto">
                    <!-- <a href="addworkspace.php"  class="btn bg-gradient-danger btn-sm mb-0" ><i class="fa-solid fa-crown"></i> Create New workspace</a> -->
                </div>
                </div>
              </div>
            </div>
            <div class="card-body px-0 pb-0">
              <div class="table-responsive">
                <table class="table table-flush" id="products-list">
                  ...
                  <tbody>
                    <?php $qry=mysqli_query($con,"select * from worksapce where is_deleted='0' order by id desc");
                      $sl=0;
                    ...
                    <tr>
                      <td class="text-sm"><?= $sl?></td>
											<td>
												<div class="d-flex px-2 py-1">
														<div>
															<?php if ($fetch['logo']==''): ?>
																	<img src="../assets1/img/workspace/1.png" class="avatar avatar-sm me-3" alt="<?=$fetch['name']?>">
															<?php endif; ?>
															<img src="../assets1/img/workspace/<?=$fetch['logo']?>" class="avatar avatar-sm me-3" alt="<?=$fetch['name']?>">
														</div>
												...
												<td class="text-sm"><?= getWorkspaceUserById($fetch['id'])?></td>
                      ...
                      <td class="text-sm">
                        <a href="workspace.php?did=<?php echo base64_encode($fetch['id']) ?>" onclick="return confirm('Are you sure want to delete??')" class="collection-item"><span class="badge badge-sm bg-gradient-danger" ><i class="fas fa-trash"></i></span></a>
                      </td>
                    </tr>
                  <?php }}else{  ?>
                  <tr><td colspan="7" align="center">--No workspace found--</td></tr>
                  <?php } ?>
                  </tbody>
                </table>
              </div>
