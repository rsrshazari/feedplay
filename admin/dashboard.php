...
<html><head>
  ...
  <title>FeedPlay | Admin Dashboard </title>
              ...
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-success shadow-success text-center rounded-circle">
                    <i class="fa-solid fa-user-check text-lg opacity-10"></i>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Chapter</p>
                    <h5 class="font-weight-bolder">
                    <?=getTotalChapterForAdmin()?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Worksapce</p>
                    <h5 class="font-weight-bolder">
                    <?= getTotalWorkspaceForAdmin()?>
                    </h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow-info text-center rounded-circle">
                    <i class="ni ni-planet text-lg opacity-10"></i>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="row mt-4">
              <div class="col-lg-12 mb-4 mb-lg-0">
                <div class="card z-index-2 h-100">
                  ...
                  <div class="card-body p-3">
                    <div class="chart">
                      <canvas id="chart-line" class="chart-canvas" height="300" width="557" style="display: block; box-sizing: border-box; height: 300px; width: 557.1px;"></canvas>
                    </div>
                  </div>
                </div>
              </div>
