    ...
    <nav  class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder text-white mb-0">My Feeds</h6>
        </nav>
                ...
                <table class="table table-flush" id="products-list">
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th>Chapter</th>
                      <th>Status</th>
											<th><i  class="fa-solid fa-thumbs-up" style="color:green;font-size:18px"></i></th>
												<th><i  class="fa-solid fa-heart" style="color:red;font-size:18px"></i></th>
													<th><i  class="fa-solid fa-face-laugh-beam" style="color:orange;font-size:18px"></i></th>
													<th><i  class="fa-solid fa-face-frown" style="font-size:18px"></i></th>
                      <th>Date</th>
                      <th>Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $qry=mysqli_query($con,"select * from feeds where user_id='$userId' order by id desc");
                      $sl=0;
                    ...
                    <tr>
                      ...
                      <td class="text-sm"><span class="badge badge-pill badge-info"><?= getAllChapterOfFeedByUser($userId,$fetch['id'])?></span></td>
                      <td class="text-sm"><?= getFeedstatus($fetch['status'])?></td>
											<td class="text-sm"><?= $fetch['likes']?></td>
											<td class="text-sm"><?= $fetch['love']?></td>
											<td class="text-sm"><?= $fetch['happy']?></td>
											<td class="text-sm"><?= $fetch['sad']?></td>
                      ...
                      <td class="text-sm">
                        ...
                        <a href="my-feeds.php?did=<?php echo base64_encode($fetch['id']) ?>" onclick="return confirm('Are you sure want to delete??')" class="collection-item"><span class="badge badge-sm bg-gradient-danger" ><i class="fas fa-trash"></i></span></a>
                      </td>
                    </tr>
                  <?php }}else{  ?>
                  <tr><td colspan="6" align="center">--No feeds found--</td></tr>
                  <?php } ?>
                  </tbody>
                </table>
              </div>
