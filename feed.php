...
<html lang="en">
  <head>
    ...
    <link href="assets1/css/feed.css" rel="stylesheet">
     ...
     <body>
      <div class="giide-outer-container">
          <div class="outer-gradient">
            <a href="#" class="logo"><img src="./assets1/img/logo.png" alt="" style="width: 40%;"></a>
                    ...
                    <div style="width: 371.25px;">
                                        ...
                                        <div class="feed-card-container" style="width: 334.125px; margin: 0px 11.1375px 14.85px;">
                                            <div class="title-card feed-card" style="height: 513.228px;">
                                                <div class="title-image-container" style="width: 337.34px; height: 337.34px;">
                                                    <img src="assets1/img/<?= $fetch['image']?>" alt="<?= $fetch['name']?>" style="display: block;">
                        ...
                        <div class="player-container" style="height: 105.6px;">
                            ...
                            <div class="player-buttons" style="height: 72.6px;">
                                ...
                                <div type="button" class="playback-rate-button dropup" style="width: 29.7px;    margin-top: -1px;"><img src='assets1/img/993536.png' style="width:100%" class="dropdown-toggle " data-bs-toggle="dropdown" id="navbarDropdownMenuLink2">
                                ...
                                <a href="#" target="_blank" rel="noopener noreferrer" class="player-logo-link" style="width: 44.55px; height: 37.125px;"><img src="./assets1/img/logo.png" alt="Feedplay logo"></a>
                              <?php }else{
                                $brand=getFeedBrand($fetch['brand']);
                                 ?>
                                  <a href="#" target="_blank" rel="noopener noreferrer" class="player-logo-link" style="width: 44.55px; height: 37.125px;"><img src="./assets1/img/logos/<?=$brand[2]?>" alt="<?=$brand[3]?>"></a>
                              <?php } ?>
